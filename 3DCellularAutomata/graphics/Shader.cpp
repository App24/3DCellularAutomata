...
{
	glUniform1i(m_getUniformLocation(name), x);
}

void Shader::uniform1f(std::string name, float x)
{
	glUniform1f(m_getUniformLocation(name), x);
}

void Shader::uniform2f(std::string name, float x, float y)
{
	glUniform2f(m_getUniformLocation(name), x, y);
}

void Shader::uniform3f(std::string name, float x, float y, float z)
{
	glUniform3f(m_getUniformLocation(name), x, y, z);
}

unsigned int Shader::m_getUniformLocation(std::string name)
{
